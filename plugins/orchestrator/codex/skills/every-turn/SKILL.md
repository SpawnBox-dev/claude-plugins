---
name: every-turn
description: Apply project history during ongoing work and capture useful new evidence with Orchestrator.
---

At a task boundary, retrieve the decisions, file-specific notes or prior failures that could change your next action. A repeated failure is a reason to search and reconsider, not repeat the same attempt.
